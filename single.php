...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 blog-content">
                        ...
                        <div class="pt-5">
                            <p>Categories: <a href="#">HTML5</a>, <a href="#">Bootstrap 4</a> Tags: <a
                                ...
                                <form action="#" class="p-5 bg-light">
                                    ...
                                    <div class="form-group">
                                        <input type="submit" value="Post Comment"
                                            class="btn btn-primary py-3 px-4 text-white">
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"rayId":"7f3e1390eb8d3e2f","version":"2023.7.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
