        ...
        <div class="col-md-7">
            ...
            <div class="card p-3 py-4">
                ...
                <div class="text-center">
                    <img src="user_profile_pic/<?php echo $fetch_user_profile_pic;?>" width="100" class="rounded-circle">
                </div>
                ...
                <div class="text-center mt-3">
                    ...
                    <div class="buttons">
                        ...
                        <button class="btn btn-dark px-4"><a href="edit_profile.php?id=<?php echo $id?>" class="text-decoration-none text-light" target="_blank">Edit Profile</a></button>
                        <button class="btn btn-success px-4 ms-3"><a href="history.php?id=<?php echo $id; ?>" class="text-decoration-none text-light" target="_blank">Purchasing History</a></button>
                    </div>
